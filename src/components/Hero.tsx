          ...
          <div className="relative rounded-3xl p-1 bg-gradient-to-b from-white/15 via-white/5 to-transparent shadow-2xl">
            <div className="rounded-[22px] bg-studio-900/90 backdrop-blur-2xl border border-white/10 p-6 sm:p-8 overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Rack Unit 1: PLUGGED 1 */}
                <div className="rounded-2xl bg-studio-950 p-5 border border-cyber-purple/30 shadow-glow-purple flex flex-col justify-between group">
                  <div>
                    <div className="flex items-center justify-between">
                      <span className="text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded bg-cyber-purple/20 text-cyber-purple border border-cyber-purple/30">
                        SYNTH & 808
                      </span>
                    ...
                    <h3 className="text-lg font-black text-white mt-3">PLUGGED 1</h3>
                    <p className="text-xs text-slate-400 mt-1">Hybrid synth & 808 engine with hardware "Cut Itself" voice choke, 808 Anti-Squeak, and knurled ADSR.</p>
                    
                    {/* Authentic Hardware GUI Screenshot */}
                    <Link href="/plugins/pluggedin_plugged1" className="my-4 block rounded-xl overflow-hidden border border-cyber-purple/20 bg-black/60 aspect-[16/10] relative group-hover:border-cyber-purple/40 transition-all flex items-center justify-center p-1.5">
                      <img
                        src="/images/plugins/pluggedin_plugged1.png"
                        alt="PLUGGED 1 Real Interface"
                        className="w-full h-full object-contain group-hover:scale-105 transition-transform duration-500"
                        onError={(e) => {
                          const target = e.currentTarget;
                          if (!target.src.includes('plugged1.png')) {
                            target.src = '/images/plugins/plugged1.png';
                          }
                        }}
                      />
                      <span className="absolute bottom-2 right-2 text-[9px] font-mono font-bold bg-black/80 backdrop-blur-sm text-cyber-purple border border-cyber-purple/30 px-2 py-0.5 rounded-full">
                        REAL JUCE GUI
                      </span>
                    </Link>
                  </div>
                  <div className="flex items-center justify-between pt-3 border-t border-white/5 text-xs">
                    <div>
                      <div className="flex items-baseline space-x-1.5">
                        <span className="font-mono text-cyber-purple font-bold text-base">$39</span>
                    ...
                    <Link
                      ...
                      className="px-3 py-1.5 rounded-lg bg-cyber-purple/15 hover:bg-cyber-purple/25 text-cyber-purple font-bold text-xs border border-cyber-purple/30 flex items-center space-x-1.5 transition-all shadow-glow-purple"
                    >
                  ...
                  <div>
                    ...
                    <Link href="/plugins/PLUGTNE" className="my-4 block rounded-xl overflow-hidden border border-cyber-cyan/20 bg-black/60 aspect-[16/10] relative group-hover:border-cyber-cyan/40 transition-all flex items-center justify-center p-1.5">
                      <img
                        ...
                        onError={(e) => {
                          const target = e.currentTarget;
                          if (!target.src.includes('plugtune.png')) {
                            target.src = '/images/plugins/plugtune.png';
                          }
                        }}
                      />
                ...
                <div className="rounded-2xl bg-studio-950 p-5 border border-cyber-rose/30 shadow-glow-rose flex flex-col justify-between group">
                  <div>
                    ...
                    <Link href="/plugins/UNDERGRND" className="my-4 block rounded-xl overflow-hidden border border-cyber-rose/20 bg-black/60 aspect-[16/10] relative group-hover:border-cyber-rose/40 transition-all flex items-center justify-center p-1.5">
                      <img
                        src="/images/plugins/underground.png"
                        ...
                        onError={(e) => {
                          ...
                          } else if (!target.src.includes('UNDERGRND.png')) {
                            target.src = '/images/plugins/UNDERGRND.png';
                          }
                        }}
                      />
