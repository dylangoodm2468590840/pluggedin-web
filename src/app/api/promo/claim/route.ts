...
> = {
  ...
  DYLAN: {
    ...
    discountPercent: 100,
    maxDevices: 5,
    message: 'Code DYLAN claimed! 100% off Lifetime All-Access Studio Pass unlocked.',
  },
  VIP: {
    tier: 'All-Access Studio Pass',
    isLifetime: true,
    discountPercent: 100,
    maxDevices: 5,
    message: 'VIP Code claimed! 100% off Lifetime All-Access Studio Pass unlocked.',
  },
  PLUGGEDVIP: {
    tier: 'All-Access Studio Pass',
    isLifetime: true,
    discountPercent: 100,
    maxDevices: 5,
    message: 'Code PLUGGEDVIP claimed! 100% off Lifetime All-Access Studio Pass unlocked.',
  },
  LIFETIMEVIP: {
    tier: 'All-Access Studio Pass',
    isLifetime: true,
    discountPercent: 100,
    maxDevices: 5,
    message: 'Code LIFETIMEVIP claimed! 100% off Lifetime All-Access Studio Pass unlocked.',
  },
  PROMO100: {
    tier: 'All-Access Studio Pass',
    isLifetime: true,
    discountPercent: 100,
    maxDevices: 5,
    message: 'Code PROMO100 claimed! 100% off Lifetime All-Access Studio Pass unlocked.',
  },
  PLUGCHOPFREE: {
    tier: 'All-Access Studio Pass',
    isLifetime: true,
