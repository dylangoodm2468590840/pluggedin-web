...
> = {
  ...
  DYLAN: {
    ...
    discountPercent: 100,
    maxDevices: 5,
    message: 'Code DYLAN applied! 100% off Lifetime All-Access Studio Pass unlocked.',
  },
  VIP: {
    tier: 'All-Access Studio Pass',
    isLifetime: true,
    discountPercent: 100,
    maxDevices: 5,
    message: 'VIP Code applied! 100% off Lifetime All-Access Studio Pass unlocked.',
  },
  PLUGGEDVIP: {
    tier: 'All-Access Studio Pass',
    isLifetime: true,
    discountPercent: 100,
    maxDevices: 5,
    message: 'Code PLUGGEDVIP applied! 100% off Lifetime All-Access Studio Pass unlocked.',
  },
  LIFETIMEVIP: {
    tier: 'All-Access Studio Pass',
    isLifetime: true,
    discountPercent: 100,
    maxDevices: 5,
    message: 'Code LIFETIMEVIP applied! 100% off Lifetime All-Access Studio Pass unlocked.',
  },
  PROMO100: {
    tier: 'All-Access Studio Pass',
    isLifetime: true,
    discountPercent: 100,
    maxDevices: 5,
    message: 'Code PROMO100 applied! 100% off Lifetime All-Access Studio Pass unlocked.',
  },
  PLUGCHOPFREE: {
